...
int _topicEstimateSize(
  ...
  bytesCount += 3 +
      LevelingSchema.estimateSize(
          object.topicLeveling, allOffsets[Leveling]!, allOffsets);
  return bytesCount;
}
...
extension TopicQueryObject on QueryBuilder<Topic, Topic, QFilterCondition> {
  QueryBuilder<Topic, Topic, QAfterFilterCondition> topicLeveling(
      FilterQuery<Leveling> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'topicLevel');
    });
  }
}
